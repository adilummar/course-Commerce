    ...
    >
      <Box boxSizing="border-box" py={'16'} px={['4', '0']}>
        ...
        >
          ...
          <Databox title="Users" qty={'79'} qtyPrecentage={30} profit={true} />
          <Databox
            title="subscription"
            qty={'12'}
            qtyPrecentage={20}
        ...
        <Grid templateColumns={['1fr', '2fr 1fr']}>
          <Box p={'4'}>
            <Heading
              ...
              ml={['0', '16']}
            />
            <Bar profit={true} title={"views"} value={"123"} />
            <Bar profit={true} title={"Users"} value={"79"} />
            <Bar profit={false} title={"Subscription"} value={"12"} />
          </Box>
          <Box p={["0","16"]} boxSizing='border-box' py={'4'}>
            <Heading textAlign={'cemter'} size={'md'} mb={'4'} children={'Users'} />
            {/* dought graph  */}
            <DoughnutChart/>
          </Box>
        </Grid>
